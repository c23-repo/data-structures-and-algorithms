...
const oddValues = (arr) => arr.filter(odds => odds%2)
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const filterStringsWithVowels = (arr) => arr.filter(vowel => vowel.match(/[aeiou]/ig));
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // let objArr = {};
  return arr.filter(i => i.baseStat > minBaseStat
  );
...
const getStatName = (arr, minBaseStat) => {
  let greaterStat = arr.filter(element => element.baseStat > minBaseStat);
  return greaterStat.map(element => element.stat.name);
};
