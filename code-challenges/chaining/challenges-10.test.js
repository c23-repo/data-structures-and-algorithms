...
const count = (target, input) => {
  if (input.length == []){
    ...
    return input.map(index => index.filter(element => element === target).reduce(accumulator => accumulator + 1, 0)).reduce((accumulator,currentValue) => accumulator + currentValue);
  }
};
...
const totalSum = (input) => {
  return input.map(index => index.reduce((accumulator,currentValue) => accumulator + currentValue)).reduce((accumulator,currentValue) => accumulator + currentValue);
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
